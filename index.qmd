...
- fish specific taxa out of many alignments at once, trimming now-empty sites, and rename them
...
The diagram below summarizes a typical `catGenes` workflow, from sequence retrieval and alignment preparation to taxon subsetting, concatenation, model selection, phylogenetic inference, and tree visualization.

![](figures/catGenes_workflow.svg)
*Overview of the main `catGenes` workflow, highlighting sequence retrieval, FASTA combination, sequence alignment, alignment conversion, fishing and renaming taxa across multiple alignments, concatenation, export of partitioned datasets, model selection, phylogenetic inference, and tree visualization.*
