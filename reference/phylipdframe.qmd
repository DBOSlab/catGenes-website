---
title: 'phylipdframe'
description: 'Writes a PHYLIP-formatted DNA alignment from a dataframe-formatted DNA alignment'
toc: true
toc-depth: 3
---
...
`read.nexus.data` into a PHYLIP-formatted file. It is useful for
...
`catmultGenes`. The function is also useful for saving into PHYLIP
