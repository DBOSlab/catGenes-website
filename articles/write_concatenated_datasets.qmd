...
![Beginning of a NEXUS-formatted concatenated matrix produced by writeNexus()](../figures/concatenatedmatrix1.png)
...
![End of the same NEXUS matrix, showing the auto-generated MrBayes block with charsets for each partition](../figures/concatenatedmatrix2.png)
...
![ITS partition of a concatenated matrix with differing identifiers kept as bracketed comments (e.g. [AF467022], [Hernandez9407_GQ250075])](figures/catGenes_with_taxlabels1.png)

![ETS partition of the same matrix — the bracketed identifiers change per partition, always reflecting which accession actually contributed data to that gene](../figures/catGenes_with_taxlabels2.png)
...
![Concatenated PHYLIP-formatted matrix produced by writePhylip()](../figures/concatenatedmatrix3.png)

And the partition file, ready to upload to RAxML or CIPRES for a mixed/partitioned-model analysis, looks like this:

![RAxML-style partition file produced alongside the PHYLIP matrix](../figures/concatenatedmatrix3_partitition.png)
