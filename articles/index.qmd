...
::: {style="display: block;"}
### Input preparation
- [Standardizing DNA alignments for `catGenes`](/articles/standardizing_alignments.qmd)
...
- [Concatenate multilocus datasets with `catfullGenes()`](/articles/concatenate_with_catfullGenes.qmd)
- [Concatenate datasets with duplicated accessions using `catmultGenes()`](/articles/concatenate_with_catmultGenes.qmd)
- [Remove redundant accessions with `dropSeq()`](/articles/remove_redundant_accessions.qmd)

### Export, analysis, and visualization
- [Export concatenated datasets with `writeNexus()`](/articles/write_nexus_datasets.qmd)
- [Export concatenated datasets with `writePhylip()`](/articles/write_phylip_datasets.qmd)
- [Model selection and MrBayes preparation with `evomodelTest()`](/articles/model_selection_and_mrbayes.qmd)
- [Run MrBayes from R](/articles/run_mrbayes.qmd)
- [Plot and edit phylogenetic trees with `plotPhylo()`](/articles/plot_phylogenetic_trees.qmd)
:::
:::
