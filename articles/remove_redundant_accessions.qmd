...
![Concatenated dataset before dropSeq(), with several species represented by multiple duplicated accessions](../figures/dropseq1.png)
...
![Same dataset after dropSeq(), now with only the most complete accession retained per species (NTAX reduced from 62 to 46)](../figures/dropseq2.png)
